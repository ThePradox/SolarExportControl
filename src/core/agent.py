...
# region Events
    ...
    def __on_inverter_power(self, value: float)-> None:
        self.limitcalc.set_production_hint(value)
...
# endregion
    ...
    def __parser_inverter_power(self, payload: bytes) -> float | None:
        return customize.parse_inverter_power_payload(payload)
